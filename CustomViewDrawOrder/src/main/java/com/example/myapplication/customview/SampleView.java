...
public class SampleView extends LinearLayout {
    ...
    private class Pattern {
        ...
        SampleView.Pattern.Spot[] spots;

        private Pattern() {
            spots = new SampleView.Pattern.Spot[4];
            spots[0] = new SampleView.Pattern.Spot(0.24f, 0.3f, 0.026f);
            spots[1] = new SampleView.Pattern.Spot(0.69f, 0.25f, 0.067f);
            spots[2] = new SampleView.Pattern.Spot(0.32f, 0.6f, 0.067f);
            spots[3] = new SampleView.Pattern.Spot(0.62f, 0.78f, 0.083f);
        }

        private Pattern(SampleView.Pattern.Spot[] spots) {
            this.spots = spots;
        }
        ...
        private void draw(Canvas canvas) {
            ...
            for (int i = 0; i < spots.length * repitition; i++) {
                SampleView.Pattern.Spot spot = spots[i % spots.length];
